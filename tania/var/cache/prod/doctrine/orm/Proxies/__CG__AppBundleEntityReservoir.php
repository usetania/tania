 ...
 */
class Reservoir extends \AppBundle\Entity\Reservoir implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Reservoir' . "\0" . 'field', '' . "\0" . 'AppBundle\\Entity\\Reservoir' . "\0" . 'areas', '' . "\0" . 'AppBundle\\Entity\\Reservoir' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Reservoir' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Reservoir' . "\0" . 'capacity', '' . "\0" . 'AppBundle\\Entity\\Reservoir' . "\0" . 'measurementUnit', '' . "\0" . 'AppBundle\\Entity\\Reservoir' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\Reservoir' . "\0" . 'createdAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Reservoir $proxy) {

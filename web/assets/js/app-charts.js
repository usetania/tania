var App = (function () {
  ...
  App.charts = function( ){
    ...
    //Line Chart 2
    function widget_linechart2(container, chartData){
      var color1 = tinycolor( chartData.color ).lighten( 5 ).toString();

    	var plot_statistics = $.plot($(container), [{
        data: chartData.data,
        label: "Page Views"
      }
      ], {
    ...
    //row 1
    var climateData = {
      data: [[0, 33.6], [1, 35.3], [2, 34.8], [3, 33], [4, 32.3], [5, 35.5], [6, 37.2], [7, 38]],
      tickColor: "rgba(33, 173, 156, 0.15)",
      color: "rgb(70, 183, 169)"
    };

    var climateDataTwo = {
      data: [[0, 35], [1, 35.3], [2, 34.8], [3, 33.3], [4, 32.4], [5, 30.2], [6, 30.5], [7, 31]],
      tickColor: "rgba(92, 144, 198, 0.15)",
      color: "rgb(107, 170, 236)"
    };
    widget_linechart2('#line-chart1', climateData);
    widget_linechart2('#line-chart2', climateDataTwo);
	    //widget_barchart2();

...
class Area extends \AppBundle\Entity\Area implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Area' . "\0" . 'reservoir', '' . "\0" . 'AppBundle\\Entity\\Area' . "\0" . 'plants', '' . "\0" . 'AppBundle\\Entity\\Area' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Area' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Area' . "\0" . 'growingMethod', '' . "\0" . 'AppBundle\\Entity\\Area' . "\0" . 'capacity', '' . "\0" . 'AppBundle\\Entity\\Area' . "\0" . 'measurementUnit', '' . "\0" . 'AppBundle\\Entity\\Area' . "\0" . 'imageFile', '' . "\0" . 'AppBundle\\Entity\\Area' . "\0" . 'image', '' . "\0" . 'AppBundle\\Entity\\Area' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\Area' . "\0" . 'createdAt'];
        }
    ...
    public function setGrowingMethod($growingMethod)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setGrowingMethod', [$growingMethod]);

        return parent::setGrowingMethod($growingMethod);
    }
    ...
    public function getGrowingMethod()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGrowingMethod', []);

        return parent::getGrowingMethod();
    }
    ...
    public function setReservoir(\AppBundle\Entity\Reservoir $reservoir = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setReservoir', [$reservoir]);

        return parent::setReservoir($reservoir);
    }
    ...
    public function getReservoir()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReservoir', []);

        return parent::getReservoir();
    }
